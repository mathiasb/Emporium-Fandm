...
class Woo_Twitter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?><div class="back"><ul id="twitter_update_list_<?php echo $unique_id; ?>"><li></li></ul>
			<p><?php _e('Follow','woothemes'); ?> <a href="http<?php if (is_ssl()) { echo 's'; } ?>://twitter.com/<?php echo $username; ?>"><strong>@<?php echo $username; ?></strong></a> <?php _e('on Twitter','woothemes'); ?></p></div><div class="clear"></div><?php
